...
function MovieDetails() {
  ...
  useEffect(() => {
    ...
    const url = `https://api.themoviedb.org/3/movie/${movieId}?language=es-MX&api_key=${apiKey}`;

    const config = {
      headers: {
        Authorization: `Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkODhjM2RjZTQ4OWJmZTU5ZTJiZjk5ZmJjNTVmOGMyNCIsInN1YiI6IjY1MWI5MTU7-17SW2vT-W8bzq-6ZR5URhoE5z4qYFZNC1`,
